...
- The main output is the balance lines only, one per opened account. Accounts that need a check (missing name, money before open, reverse of a missing event) also print separately as `REVIEW <accountId> <reasons>`.
